========================================================================
    KONSOLENANWENDUNG: 7_Segment_Visualizer-Projektübersicht
========================================================================

Diese 7_Segment_Visualizer-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 7_Segment_Visualizer-Anwendung besteht.


7_Segment_Visualizer.vcxproj
...
7_Segment_Visualizer.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 7_Segment_Visualizer.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
